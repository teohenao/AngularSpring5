...
export class PaginatorComponent implements OnInit,OnChanges {
  ...
  //a travez del change podemos obtener el campo del input paginador que tenemos declarado
  ngOnChanges(changes:SimpleChanges)
  {
     let paginadorActualizaco = changes['paginador'];
     //si paginador actualizado tiene un estado anterior y haya cambiado
     if(paginadorActualizaco.previousValue)
     {
      this.initPaginator();
     }
  }
