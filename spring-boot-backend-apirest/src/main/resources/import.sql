...
INSERT INTO `usuarios` (username,password,enabled,nombre,apellido,email) VALUES ('andres','$2a$10$igyQApzP7pNJ9E3Ns/skz.d6i1M/.NIlMByiZZ4rDgNV2gInLNGGm
',1,'Andres','Guzman','email1@gmail.coma');
INSERT INTO `usuarios` (username,password,enabled,nombre,apellido,email) VALUES ('amin','$2a$10$W49sdMHj4I/Xw/I3YapD3OER7aa0VTZIj33KQCKhiRw2ifoQlqdPC
',1,'Andres2','Guzman2','email2@gmail.coma');
